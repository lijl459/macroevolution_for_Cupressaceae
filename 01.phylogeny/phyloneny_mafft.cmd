...
echo "/home/user001/script/perl/fasta-missing.pl $i 50 3 >$out3/${basename}.fas" >>gt.sh
done
...
#Step 4 using python script to removed length of gaps more than halp of aligment sequences
...
python /home/user001/script/phylogeny/filtering_alignment_missing.py $out3 $out4  $nsp
